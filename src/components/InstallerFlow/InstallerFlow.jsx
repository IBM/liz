...
const InstallerFlow = ({ onProgress, progressStep, progressStepCompletion }) => {
  return (
    <>
      ...
      >
        <ProgressStep
          complete={progressStepCompletion.inputFileSelection}
